    ...
    <header className="px-6 py-8" style={styles.header}>
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
        ...
        <div className="flex items-center gap-4 sm:gap-6 flex-1">
          {/* Profile Picture */}
          <div className="h-16 w-16 sm:h-20 sm:w-20 shrink-0 overflow-hidden" style={styles.avatar}>
            {user.avatarUrl ? (
              <img
              ...
              <div
                className="h-full w-full flex items-center justify-center text-xl sm:text-2xl"
